...
import { faBusAlt, faMapMarkerAlt } from "@fortawesome/free-solid-svg-icons"
...
const WayToCome = () => {
    ...
    React.useEffect(() => {
        if (window !== undefined && document !== undefined) {
            ...
            script.defer = true
            script.src = `https://dapi.kakao.com/v2/maps/sdk.js?appkey=4fc661cc5efee39dc7d901aabff3c1b9&autoload=false`
        ...
        >
            ...
            <div className={"mt-10 md:flex block w-full"}>
                ...
                <div className={"w-full md:pl-4"}>
                    ...
                    <p className={"text-md font-thin"}>
                        지하철 이용시: 진천역 4번출구 방향, 월배역 1번 출구 방향
                        200m 위치
                        <br />
                        버스이용시: 600, 650, 651, 836, 달서5, 달성2. 월배시장
                        건너 정류장 하차
                    </p>
                </div>
            </div>

...
export type SiteFieldsEnum =
  ...
  | 'siteMetadata___menuLinks___subMenu'
  | 'siteMetadata___menuLinks___subMenu___name'
  | 'siteMetadata___menuLinks___subMenu___link'
...
export type Unnamed_1_Query = { site?: { siteMetadata?: { menuLinks: Array<{ name: string, link: string, subMenu?: Array<{ name?: string | null, link?: string | null } | null> | null } | null> } | null } | null };
...
export type Unnamed_3_Query = { mdx?: { id: string, body: string, frontmatter?: { title: string, subtitle?: string | null, date?: any | null, author?: string | null } | null } | null };

export type PaginatedQueryQueryVariables = Exact<{
  limit: Scalars['Int'];
  skip: Scalars['Int'];
}>;


export type PaginatedQueryQuery = { allMdx: { totalCount: number, nodes: Array<{ id: string, excerpt: string, frontmatter?: { title: string, subtitle?: string | null, author?: string | null, date?: any | null } | null, fields?: { slug?: string | null } | null }> } };
